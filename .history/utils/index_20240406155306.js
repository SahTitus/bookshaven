...
export const bookValidationSchema = Yup.object().shape({
    ...
    de: Yup.string().required('Summary is required'),
    category: Yup.string().required('Category is required'),
    subCategory: Yup.string('Sub-Category is required'),
    isTutorial: Yup.boolean().required('Is Tutorial is required'),
    requiresAuth: Yup.boolean().required('Requires Authentication is required'),
