...
export const InputWithDropdown = ({ label, options,isSidebar, toggleSidebar, id }) => {
  ...
  return (
    <div className='flex justify-between items-center py-3 w-full'>    <form onSubmit={handleSubmit} className="relative" >

      <input
        type={'text'}
        placeholder={label}
        className='bg-transparent flex-1 h-full outline-none'        required={true}
