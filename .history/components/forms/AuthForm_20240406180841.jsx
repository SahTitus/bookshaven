...
export const AuthForm = () => {
    ...
    return (
        <div className={``}>
            <div className="relative flex-col mt-6 flex items-center justify-center select-none w-11/12  md:w-[70%] max-w-xl mx-auto text-center md:text-start rounded-lg border px-5 py-4 transition-colors z-50  border-neutral-700">
                ...
                <Formik  initialValues={initialValues.user} validationSchema={validationSchema} onSubmit={submit}>
                    {({ values, setFieldValue }) => (
                        <Form className="  shadow-md rounded px-4 py-5 gap-3 flex flex-col w-full">
                            {!isSignIn && <>
