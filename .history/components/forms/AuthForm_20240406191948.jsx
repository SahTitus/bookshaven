            ...
            <div className="relative bg-[#f7f7f7] flex-col mt-20 flex items-center justify-center select-none w-11/12  md:w-[70%] max-w-xl mx-auto text-center md:text-start rounded-lg border px-5 py-4  ">
               <h1 className='text-black text-3xl font-bold'>Create Account</h1>
                ...
                <div className='flex justify-between gap-4 mb-3 mt-5'>
                    <p onClick={() => setIsSignIn(true)} className={`${isSignIn ? 'border-b border-zinc-500 rounded-lg' : ''} flex items-center justify-center text-xl font-bold  py-2 px-5 text-gray-800 cursor-pointer`}>Sign in</p>
