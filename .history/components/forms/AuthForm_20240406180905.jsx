...
export const AuthForm = () => {
    ...
    return (
        <div className={``}>
            <div className="relative flex-col mt-6 flex items-center justify-center select-none w-11/12  md:w-[70%] max-w-xl mx-auto text-center md:text-start rounded-lg border px-5 py-4  ">
