...
const fieldStyles = `shadow text-zinc-800 appearance-none bg-slate-200 py-4 border border-zinc-500 rounded w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:shadow-outline`
