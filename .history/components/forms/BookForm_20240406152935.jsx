...
const fieldStyles = `shadow appearance-none bg-slate-800 py-4 border border-slate-600 rounded w-full py-2 px-3 text-gray-300 leading-tight focus:outline-none focus:shadow-outline`
const labelStyles = `block text-zinc-300 text-lg font-bold mb-2 mt-6 `;
    ...
    <div className="bg-white min-h-screen flex items-center justify-center">
      <Formik initialValues={defaultFormValues} validationSchema={bookValidationSchema} onSubmit={handleSubmit}>
        {({ values, setFieldValue }) => (
          <Form className="bg-white shadow-md rounded px-2 md:px-8 pt-6 pb-8 mb-4 flex flex-col w-11/12 md:w-3/4 ">
