...
const fieldStyles = `shadow appearance-none bg-slate-200 py-4 border border-grey-600 rounded w-full py-2 px-3 text-gray-300 leading-tight focus:outline-none focus:shadow-outline`
