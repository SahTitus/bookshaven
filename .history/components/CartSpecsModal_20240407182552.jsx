...
const CartSpecsModal = () => {
  ...
  const [itemsToDeleteIds, setSelecetdIds] = useState([]);
    ...
    >
      <div className={styles.modalContent}>
        ...
        <div className={styles.cartSpecs}>
          {cartBooks.map(book => (
            <CartCard itemsToDeleteIds={itemsToDeleteIds} setSelecetdIds={setSelecetdIds} key={book?._id} book={book} user={user} cart_id={book?._id} />
          ))}
        </div>
      </div>
    </div>
