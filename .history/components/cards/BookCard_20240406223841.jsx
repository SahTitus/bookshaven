      ...
      <div className={`${styles.bookCard} shadow rounded-lg`}>
        <div className={styles.card__wrapper}>
          ...
          <div className={`${styles.product__info} py-2 space-y-1`}>
            ...
            <p className=' text-slate-600 p-1 rounded-sm'><span>by</span> {book?.author_firstName} {book?.author_lastName}</p>
       <div className="flex alif">
       4.5 <Rating ratings={[3,0,0,0,0]} />
       </div>
            <div className="flex justify-between text-sm items-center">
              <button aria-label="view-book" type="button" className='bg-[#ec6641] text-white p-1 rounded-sm w-full'>View Book</button>
