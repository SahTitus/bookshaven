...
export const BookCard = ({ book, isLoading }) => {
  ...
  return (
    <Link onClick={handleOnClick} href={`/books/${book?._id}`}>
      <div className={`${styles.bookCard} shadow rounded-lg bg-orange-100`}>
        <div className={styles.card__wrapper}>
          ...
          <div className={`${styles.product__info} py-2 space-y-1`}>
            ...
            <strong className={`${styles.price} text-orange1 tracking-wider`}>GHS{book?.price?.toFixed(2)}</strong>
