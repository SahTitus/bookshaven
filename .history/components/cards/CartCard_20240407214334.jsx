...
const CartCard = ({ book, cart_id, user,selectedIds, setSelecetdIds }) => {

  const { setCartBooks, setTotalCartQnty,setShowLoaderOverlay } = useStateContex();
  ...
  const handleCardSelect = (id) => {
    const idExist = selectedIds.includes(id);
