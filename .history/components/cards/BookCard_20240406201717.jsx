...
import { INITIALSTATES } from "@lib/constants/initialStates";

export const BookCard = ({ product, isLoading }) => {
  const { preorder, title, price, moq, images, orders, _id, seller_type, condition } = product || INITIALSTATES.product;
  console.log(product)
  const imgUrl = images[0]?.url || `/images/gyasoload.png`;
