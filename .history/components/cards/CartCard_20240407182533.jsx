...
const CartCard = ({ book, cart_id, user, isLoading,s, setSelecetdIds }) => {
  ...
  const handleCardSelect = (id) => {
    const idExist = s.includes(id);

    if (idExist) {
      const updatedIds = s?.filter((item) => item !== id);
