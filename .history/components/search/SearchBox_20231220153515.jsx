...
export const SearchBox = ({ toggleSidebar, isSidebar, defaultQuery }) => {
    ...
    return (
        <div className='flex justify-between items-center py-3 w-full'>
            <form onSubmit={handleSubmit} className='flex justify-between items-center gap-2 bg-transparent rounded-full h-[54px] pl-3 w-full shadow-inner  shadow-slate-300'>
                <input
