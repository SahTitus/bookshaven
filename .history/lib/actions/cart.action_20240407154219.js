...
export async function updateCart(data) {
    try {
        ...
        console.log(itemToUpdate.userID.toHexString(),'sharp££££££££')

        if (!itemToUpdate._id || itemToUpdate.userID.toHexString() != userData._id) {
        ...
        const updatedCart = await Cart.findByIdAndUpdate(Cart._id, itemToUpdate, { new: true });
