    ...
    return (
        <div>
            <div className='flex flex-col h-fit'>
                <div className={``}
                >
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere officiis ab fugiat laudantium temporibus. Iste similique quae modi libero vero tenetur repudiandae nesciunt impedit saepe, aliquid, exercitationem iusto, suscipit ipsum?
                    <Image
                        src={book?.image}
                        width={180}
                        height={150}
