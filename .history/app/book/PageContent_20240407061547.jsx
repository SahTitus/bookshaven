...
export const PageContent = ({ book }) => {
    return (
        <div>
            <div className='flex flex-col h-fit pb-6 sm:flex-row sm:ite'>
                ...
                >
                    <Image
                        ...
                        className={` border border-slate-100 p-3 rounded-xl  ${'w-[240px] h-[290px] md:h-[370px]'} shadow-lg relative overflow-hidden`}
                        placeholder="blur"
