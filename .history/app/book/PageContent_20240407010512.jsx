                ...
                <div className='flex flex-col mt-4 px-4'>
                    ...
                    <div className='flex flex-col justify-between  items-center gap-2 text-gray mt-3'>
                        <p className='flex items-center gap-2 bg-slate-200 w-full p-2'>
                            <span className='font-semibold text-lg w-2/3'>Genre</span>
                            <span>{book?.genre}</span>
                        </p>
                        <p className='flex items-center gap-2 bg-slate-200 w-full p-2'>
                            <span className='font-semibold text-lg w-2/3'>Category</span>
                            <span>{book?.category}</span>
                        </p>
                        <p className='flex items-center gap-2 bg-slate-200 w-full p-2'>
                            <span className='font-semibold text-lg w-2/3'>ISBN</span>
                            <span>{book?.ISBN}</span>
                        </p>
                        <p className='flex items-center gap-2 bg-slate-200 w-full p-2'>
                            <span className='font-semibold text-lg w-2/3'>Availability</span>
                            <span>{book?.availability}</span>
                        </p>
                        <p className='flex items-center gap-2 bg-slate-200 w-full p-2'>
                            <span className='font-semibold text-lg w-2/3'>Pages</span>
