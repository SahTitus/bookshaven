            ...
            <div className='flex flex-col h-fit pb-6 sm:flex-row sm:items-start'>
                ...
                >
                    ...
                    <div className='flex items-center mt-4 mb-8 justify-between  bg-[#edbc37]  shadow-lg  z-20 rounded-full h-[45px] w-[13rem] text-white '>
                        <span onClick={() => handleQuantityChange(-1)} className='text-xl h-full bg-[#f8d985] cursor-pointer flex text-center justify-center items-center w-full rounded-l-full'> /></span>
