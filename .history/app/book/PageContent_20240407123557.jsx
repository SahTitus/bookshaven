            ...
            <div className='flex flex-col h-fit pb-6 sm:flex-row sm:items-start'>
                ...
                <div className='flex flex-col mt-4 px-4'>
                    ...
                    <div className='flex justify-between items-center gap-2 mt-14' >
                        ...
                        {quantity > 0 ? <button onClick={() => handle} type='button' className=' bg-[#ec6641] z-20  text-white py-2 px-4 font-semibold rounded-full'>Add to Cart</button> : <button className=' bg-[#ec6641] z-20  text-white py-2 px-4 font-semibold rounded-full'>Buy Now</button>}
