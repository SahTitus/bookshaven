                    ...
                    <div className='flex justify-between items-center gap-2 mt-14' >
                        ...
                        <div className='relative flex flex-col  gap-2 text-gray'>
                            ...
                            <p className='flex items-center justify-between  bg-[#edbc37]  shadow-lg  z-20 rounded-full h-[45px] w-[13rem] text-white '>
                                <span className='text-xl h-full bg-[#f8d985] cursor-pointer flex text-center justify-center items-center w-full rounded-l-full'><FaMinus /></span>
                                <span className='text-2xl font-semibold px-6'>7</span>
                                <span className='text-xl h-full  cursor-pointer  bg-[#f0b513] rounded-r-full flex text-center justify-center items-center w-full'><FaPlus /> </span>
                            </p>
                        </div>
