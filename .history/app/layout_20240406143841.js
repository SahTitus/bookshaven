...
export const metadata = {
  title: siteName,
  siteName: siteName,
  description: 'Book Haven - Your go-to destination for all kinds of book',
  icons: {
    icon: clientRoutes.algogenzIcon,
    shortcut: clientRoutes.algogenzIcon,
    apple: clientRoutes.algogenzIcon,
    other: {
      rel: clientRoutes.algogenzIcon,
      url: clientRoutes.algogenzIcon,
    },
