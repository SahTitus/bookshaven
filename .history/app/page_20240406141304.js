...
export default async function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col  justify-between px-2  pt-14 md:pt-20 select-none">
      ...
      {/* <TopCategories categories={popularCategories} label='Top Categories' /> */}
      <section className='flex flex-col gap-8 md:max-w-3xl md:mx-auto'>
        ...
        <Pagination pathHasQmark={false} path={clientRoutes.blog} totalPages={latestArticles?.totalPages} currentPage={1} showPagination={false} />
      </section>
